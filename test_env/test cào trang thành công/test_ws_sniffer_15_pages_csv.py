...
async def run_ws_sniffer_15_pages_csv():
    print("[*] Starting raw WebSocket 15-Page CDP Sniffer (CSV Output)...")
    ...
    async with websockets.connect(ws_url, max_size=20 * 1024 * 1024) as ws:
        ...
        for current_page in range(1, 16):
            ...
            # If we reached Page 15, do not click Next Page
            if current_page == 15:
                print("[*] Reached target Page 15. Completed.")
                break
    ...
    # Save results to discovered_creatives_15_pages.csv
    out_file = "test_env/discovered_creatives_15_pages.csv"
    headers = [
...
if __name__ == '__main__':
    asyncio.run(run_ws_sniffer_15_pages_csv())
